...
const SelfPeer = () => {
  ...
  const questionsData = {
    Solution: [
      { title2: "SOLUTION Culture", question_id: "qs1", question: "Bersikap dengan sopan dan ramah", category: "Serve" },
      { title2: "SOLUTION Culture", question_id: "qs2", question: "Menunda-nunda pekerjaan", category: "Open-Mind" },
      { title2: "SOLUTION Culture", question_id: "qs3", question: "Mematuhi semua peraturan yang berlaku", category: "Leadership" },
      { title2: "SOLUTION Culture", question_id: "qs4", question: "Mengelola waktu secara efisien", category: "Uniqueness" },
      {
        title2: "SOLUTION Culture", question_id: "qs5",
        question: "Memiliki semangat juang dan pantang menyerah", category: "Totality"
      },
      {
        title2: "SOLUTION Culture", question_id: "qs6",
        question: "Berani mengambil peran positif untuk menyelesaikan masalah", category: "Innovative"
      },
      {
        title2: "SOLUTION Culture", question_id: "qs7",
        question:
          "Menolak keceriaan di lingkungan kerja (terlalu kaku & formal)", category: "Open-Mind"
      },
      {
        title2: "SOLUTION Culture", question_id: "qs8",
        question:
          "Mampu memotivasi diri sendiri untuk berpikir & bertindak berbeda dari biasanya", category: "Uniqueness"
      },
      {
        title2: "SOLUTION Culture", question_id: "qs9",
        question: "Menunjukkan kesesuaian kata dan perbuatan", category: "Totality"
      },
      {
        title2: "SOLUTION Culture", question_id: "qs10",
        question: "Merupakan pribadi yang penuh rasa ingin tahu", category: "Open-Mind"
      },
      {
        title2: "SOLUTION Culture", question_id: "qs11",
        question:
          "Melihat tantangan sebagai peluang untuk melakukan perbaikan atau inovasi", category: "Innovative"
      },
      { title2: "SOLUTION Culture", question_id: "qs12",
        question: "Pribadi yang mudah beradaptasi" , category: "Networking"},
      {
        title2: "SOLUTION Culture", question_id: "qs13",
        question:
          "Menjaga hubungan internal atau eksternal yang terbentuk secara efektif", category: "Networking"
      },
      {
        title2: "SOLUTION Culture", question_id: "qs14",
        question:
  ...
  useEffect(() => {
    ...
    fetchBatch();
    if (selectedTask) {
      fetchAssessment();  // Fetch Assessment
  ...
  const handleSecond = async (task, role) => {
    // Selalu set selected task
        ...
        <div className="description">
          ...
          <div className="selfpeer-box">
            <div className="selfpeer-text">
              ...
              <div className="selfpeer-batch">Batch {batchNumber}</div>                      
            </div>
